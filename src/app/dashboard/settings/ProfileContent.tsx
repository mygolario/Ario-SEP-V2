  ...
  return (
    <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-8">
      ...
      <div className="flex items-center gap-6">
        ...
        <div>
          <h3 className="text-xl font-bold text-slate-900">
            {user.user_metadata?.full_name || 'کاربر گرامی'}
          </h3>
      ...
      <form action={handleSave} className="space-y-6 max-w-lg">
        ...
        {message && (
          <div
            className={`p-3 rounded-lg text-sm flex items-center gap-2 ${message.type === 'success' ? 'bg-emerald-50 text-emerald-700' : 'bg-rose-50 text-rose-700'}`}
          >
      ...
      <div className="border-t border-slate-100 pt-6">
        ...
        <form action={handleSignOut}>
          <Button
            variant="outline"
            className="border-rose-200 text-rose-600 hover:bg-rose-50 hover:text-rose-700 hover:border-rose-300 gap-2"
          >
