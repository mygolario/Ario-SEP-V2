...
export function WebsitePreview({ data }: { data: BusinessData }) {
  if (!data) return null;
  ...
  return (
    <div className="w-full h-full flex flex-col border border-slate-200 dark:border-slate-800 rounded-xl shadow-2xl overflow-hidden bg-white dark:bg-slate-950 mb-8">
      {/* Browser Bar */}
      <div className="h-10 bg-slate-100 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center px-4 justify-between" dir="ltr">
