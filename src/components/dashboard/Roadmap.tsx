  ...
  return (
    <div className="w-full space-y-8" dir="rtl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">نقشه راه ۳۰ روزه</h2>
            <p className="text-slate-500 dark:text-slate-400">برنامه عملیاتی گام‌به‌گام برای راه‌اندازی</p>
        </div>
      </div>
